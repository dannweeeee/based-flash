...
export default function TimeImage({
  ...
  useEffect(() => {
    ...
    const generateImage = () => {
      ...
      ctx.font =
        '600 56px system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif';
      ...
      ctx.font =
        '400 20px system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif';
